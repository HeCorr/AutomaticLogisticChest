data:extend({
	...
	{
		type = "int-setting",
		name = "AutomaticLogisticChest-MinRequester",
		setting_type = "runtime-global",
		default_value = 0,
		minimum_value = 0,
		maximum_value = 32,
	...
	{
		type = "int-setting",
		name = "AutomaticLogisticChest-MaxRequester",
		setting_type = "runtime-global",
		default_value = 0,
		minimum_value = 0,
		maximum_value = 32,
	...
	{
		type = "int-setting",
		name = "AutomaticLogisticChest-MinProvider",
		setting_type = "runtime-global",
		default_value = 0,
		minimum_value = 0,
		maximum_value = 32,
	...
	{
		type = "int-setting",
		name = "AutomaticLogisticChest-MaxProvider",
		setting_type = "runtime-global",
		default_value = 0,
		minimum_value = 0,
		maximum_value = 32,
